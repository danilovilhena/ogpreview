  ...
  return (
    <header className="w-full py-6 px-4">
      <div className="max-w-5xl mx-auto flex items-center justify-between gap-4">
        <Link
          href="/"
          className="flex items-center gap-1.5 text-2xl font-serif text-sky-600 italic font-medium hover:text-sky-700 transition-colors flex-shrink-0"
        >
          <Logo className="size-6" />
          ogpreview.co
        </Link>

        <div className="relative w-full max-w-64 flex-shrink-0">
